 ...
 * @author pc
 */
public class TypeIII extends Cardboard {

    public TypeIII(float newWidth, float newLength, float newHeight, int newColour, int newType, int newGrade, boolean newBottom, boolean newCornor, boolean newSealableTop) {
