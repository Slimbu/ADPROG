 ...
 * @author pc
 */
public class TypeI extends Cardboard {
    
    public TypeI (float newWidth, float newLength, float newHeight, int newColour, int newType, int newGrade, boolean newBottom, boolean newCornor, boolean newSealableTop) {
