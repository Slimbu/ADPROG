 ...
 * @author pc
 */
public class TypeII extends Cardboard {

    public TypeII(float newWidth, float newLength, float newHeight, int newColour, int newType, int newGrade, boolean newBottom, boolean newCornor, boolean newSealableTop) {
